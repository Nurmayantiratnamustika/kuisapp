...
public class IsiMateriSejarah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.isi_materisejarah);
        getSupportActionBar().setTitle("Sejarah");
        materi1 = findViewById(R.id.materisejarah);

        final FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference ref = database.getReference().child("materi").child("sejarah");
